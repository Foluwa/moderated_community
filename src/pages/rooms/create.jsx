                ...
                <div className="bg-dark-2 md:shadow-lg shadow-none rounded p-10">
                    ...
                    <form onSubmit={CreateRoom} className="my-8 w-96 h-auto">
                        <div className="relative mb-2">
                            <label htmlFor="name" className="text-[12.5px] leading-tighter text-gray-300 font-medium text-base cursor-text">Room Name</label>
                        ...
                        <div className="relative mb-2">
                            <label htmlFor="name" className="text-[12.5px] leading-tighter text-gray-300 font-medium text-base cursor-text">Password</label>
                            <input id="password" autoComplete='off' className="text-white bg-dark-3 transition-all duration-200 w-full rounded-lg p-3 border border-gray-300/10 focus:border-blue-700 outline-none ring-none" type="password" />
                        </div>
